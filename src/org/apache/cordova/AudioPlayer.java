    ...
    implements android.media.MediaPlayer.OnCompletionListener, android.media.MediaPlayer.OnPreparedListener, android.media.MediaPlayer.OnErrorListener
{
    public static final class MODE extends Enum
    {
        ...
        {
            return (MODE)Enum.valueOf(org/apache/cordova/AudioPlayer$MODE, s);
        }
    ...
    public static final class STATE extends Enum
    {
        ...
        {
            return (STATE)Enum.valueOf(org/apache/cordova/AudioPlayer$STATE, s);
        }
        ...
        static 
        {
            ...
            astate[0] = MEDIA_NONE;
            astate[1] = MEDIA_STARTING;
            astate[2] = MEDIA_RUNNING;
            astate[3] = MEDIA_PAUSED;
            astate[4] = MEDIA_STOPPED;
            astate[5] = MEDIA_LOADING;
            $VALUES = astate;
        }
        ...
        throws IllegalArgumentException, SecurityException, IllegalStateException, IOException
    {
        ...
        if (s.startsWith("/android_asset/"))
        {
            ...
            AssetFileDescriptor assetfiledescriptor = handler.cordova.getActivity().getAssets().openFd(s1);
        ...
        {
            player.setDataSource((new StringBuilder()).append("/sdcard/").append(s).toString());
        }
        setState(STATE.MEDIA_STARTING);
        player.setOnPreparedListener(this);
        player.prepare();
    ...
    private boolean playMode()
    {
        static class _cls1
        {
            ...
            static 
            {
                $SwitchMap$org$apache$cordova$AudioPlayer$STATE = new int[STATE.values().length];
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$STATE[STATE.MEDIA_NONE.ordinal()] = 1;
                }
                catch (NoSuchFieldError nosuchfielderror) { }
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$STATE[STATE.MEDIA_LOADING.ordinal()] = 2;
                }
                catch (NoSuchFieldError nosuchfielderror1) { }
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$STATE[STATE.MEDIA_STARTING.ordinal()] = 3;
                }
                catch (NoSuchFieldError nosuchfielderror2) { }
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$STATE[STATE.MEDIA_RUNNING.ordinal()] = 4;
                }
                catch (NoSuchFieldError nosuchfielderror3) { }
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$STATE[STATE.MEDIA_PAUSED.ordinal()] = 5;
                }
                catch (NoSuchFieldError nosuchfielderror4) { }
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$STATE[STATE.MEDIA_STOPPED.ordinal()] = 6;
                }
                catch (NoSuchFieldError nosuchfielderror5) { }
                $SwitchMap$org$apache$cordova$AudioPlayer$MODE = new int[MODE.values().length];
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$MODE[MODE.PLAY.ordinal()] = 1;
                }
                catch (NoSuchFieldError nosuchfielderror6) { }
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$MODE[MODE.NONE.ordinal()] = 2;
                }
                catch (NoSuchFieldError nosuchfielderror7) { }
                try
                {
                    $SwitchMap$org$apache$cordova$AudioPlayer$MODE[MODE.RECORD.ordinal()] = 3;
                }
        ...
        _cls1..SwitchMap.org.apache.cordova.AudioPlayer.MODE[mode.ordinal()];
...
_L3:
        ...
        handler.webView.sendJavascript((new StringBuilder()).append("cordova.require('cordova/plugin/Media').onStatus('").append(id).append("', ").append(MEDIA_ERROR).append(", { \"code\":").append(MEDIA_ERR_ABORTED).append("});").toString());
        return false;
    }
...
label3:
                    {
                        if (playMode())
                        {
                            switch (_cls1..SwitchMap.org.apache.cordova.AudioPlayer.STATE[state.ordinal()])
                            {
                            default:
    ...
    private void setState(STATE state1)
    {
        if (state != state1)
        {
            handler.webView.sendJavascript((new StringBuilder()).append("cordova.require('cordova/plugin/Media').onStatus('").append(id).append("', ").append(MEDIA_STATE).append(", ").append(state1.ordinal()).append(");").toString());
        }
        state = state1;
    }
    ...
    public long getCurrentPosition()
    {
        if (state == STATE.MEDIA_RUNNING || state == STATE.MEDIA_PAUSED)
        {
            ...
            handler.webView.sendJavascript((new StringBuilder()).append("cordova.require('cordova/plugin/Media').onStatus('").append(id).append("', ").append(MEDIA_POSITION).append(", ").append((float)i / 1000F).append(");").toString());
            return (long)i;
        } else
        {
            return -1L;
    ...
    public void moveFile(String s)
    {
        ...
        if (!s.startsWith("/"))
        {
            if (Environment.getExternalStorageState().equals("mounted"))
            {
                s = (new StringBuilder()).append(Environment.getExternalStorageDirectory().getAbsolutePath()).append(File.separator).append(s).toString();
            } else
            {
                s = (new StringBuilder()).append("/data/data/").append(handler.cordova.getActivity().getPackageName()).append("/cache/").append(s).toString();
            }
        }
        s1 = (new StringBuilder()).append("renaming ").append(tempFile).append(" to ").append(s).toString();
        Log.d("AudioPlayer", s1);
        if (!file.renameTo(new File(s)))
        {
            Log.e("AudioPlayer", (new StringBuilder()).append("FAILED ").append(s1).toString());
        }
    }
    ...
    public boolean onError(MediaPlayer mediaplayer, int i, int j)
    {
        ...
        player.stop();
        player.release();
        handler.webView.sendJavascript((new StringBuilder()).append("cordova.require('cordova/plugin/Media').onStatus('").append(id).append("', { \"code\":").append(i).append("});").toString());
        return false;
    }
    ...
    public void onPrepared(MediaPlayer mediaplayer)
    {
        ...
        duration = getDurationInSeconds();
        prepareOnly = true;
        handler.webView.sendJavascript((new StringBuilder()).append("cordova.require('cordova/plugin/Media').onStatus('").append(id).append("', ").append(MEDIA_DURATION).append(",").append(duration).append(");").toString());
    }
    ...
    public void pausePlaying()
    {
        ...
        } else
        {
            ...
            handler.webView.sendJavascript((new StringBuilder()).append("cordova.require('cordova/plugin/Media').onStatus('").append(id).append("', ").append(MEDIA_ERROR).append(", { \"code\":").append(MEDIA_ERR_NONE_ACTIVE).append("});").toString());
            return;
        }
    }
    ...
    {
        switch (_cls1..SwitchMap.org.apache.cordova.AudioPlayer.MODE[mode.ordinal()])
        {
        default:
            return;
