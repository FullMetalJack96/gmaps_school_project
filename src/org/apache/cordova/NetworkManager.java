...
public class NetworkManager extends CordovaPlugin
{
    ...
    {
        String s = getConnectionInfo(networkinfo);
    ...
    public boolean execute(String s, JSONArray jsonarray, CallbackContext callbackcontext)
    {
        if (s.equals("getConnectionInfo"))
        {
            ...
            PluginResult pluginresult = new PluginResult(org.apache.cordova.api.PluginResult.Status.OK, getConnectionInfo(networkinfo));
            pluginresult.setKeepCallback(true);
    ...
    public void initialize(CordovaInterface cordovainterface, CordovaWebView cordovawebview)
    {
        ...
        if (receiver == null)
        {
            ...
            cordovainterface.getActivity().registerReceiver(receiver, intentfilter);
            registered = true;
        }
    }
