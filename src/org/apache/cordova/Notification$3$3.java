        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            if (buttonLabels.length() > 2)
            {
                try
                {
                    builder.setPositiveButton(buttonLabels.getString(2), result. new Notification._cls3._cls3());
                }
...
_L2:
        ...
        // Unreferenced inner class org/apache/cordova/Notification$3$2

/* anonymous class */
        class Notification._cls3._cls2
            implements android.content.DialogInterface.OnClickListener
        {
