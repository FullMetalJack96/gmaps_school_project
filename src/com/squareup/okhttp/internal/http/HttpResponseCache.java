...
//            HttpURLConnectionImpl, HttpsURLConnectionImpl, HttpEngine, ResponseHeaders, 
...
_L6:
    ...
    public void trackResponse(ResponseSource responsesource)
    {
        ...
        i = _cls2..SwitchMap.com.squareup.okhttp.ResponseSource[responsesource.ordinal()];
        i;
...
/*
    static int access$408(HttpResponseCache httpresponsecache)
    {
...
/*
    static int access$508(HttpResponseCache httpresponsecache)
    {
...
*/
    ...
    // Unreferenced inner class com/squareup/okhttp/internal/http/HttpResponseCache$CacheRequestImpl$1
