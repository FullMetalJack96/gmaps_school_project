    ...
    implements OkResponseCache
{
    ...
    {
        HttpResponseCache.access$100(HttpResponseCache.this);
    }

    public void trackResponse(ResponseSource responsesource)
    {
        HttpResponseCache.access$200(HttpResponseCache.this, responsesource);
    }

    public void update(CacheResponse cacheresponse, HttpURLConnection httpurlconnection)
        throws IOException
    {
        HttpResponseCache.access$000(HttpResponseCache.this, cacheresponse, httpurlconnection);
    }
